...
def create_common_data_format_tables(session,dirpath='db_schema/'):
...
def enum_table_list(dirpath='db_schema'):
...
def fill_cdf_enum_tables(session,schema,dirpath='db_schema'):
